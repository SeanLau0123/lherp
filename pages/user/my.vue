	...
	<view style="height: 100vh;">
		...
		<scroll-view>
			...
			<u-cell-group title="基础">
				<u-cell-item icon="more-circle" :title-style="cellTitleStyle" title="个人详情"
					@click="ToUserDetail()"></u-cell-item>
				<u-cell-item icon="photo" :title-style="cellTitleStyle" title="切换主题"
					@click="ToChangeTheme()"></u-cell-item>
				<u-cell-item icon="lock-open" :title-style="cellTitleStyle" title="修改密码"
					@click="ToChangePwd()"></u-cell-item>
				<u-cell-item icon="error-circle" :title-style="cellTitleStyle" title="关于我们"
					@click="ToAbout()"></u-cell-item>
			</u-cell-group>
