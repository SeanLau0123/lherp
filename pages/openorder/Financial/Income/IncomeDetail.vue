				...
				<view class="good-item" style="min-height: 80rpx;">
					<u-collapse :head-style="headStyle">
						<u-collapse-item :title="`单据行明细 - 共 ${listTotal} 行`">
							<view v-for="(inout, index) in accountDetail" :key="inout.inOutItemId || index">
								<template v-if="inout.inOutItemId">
									<view class="good-item" style="min-height: 80rpx;">
										<u-row gutter="10">
											<u-col span="11">
												<view class="goods-row">
													<text class="label">收入项目：</text>
													<text class="value">{{ inout.inOutItemName || '-' }}</text>
												</view>
											</u-col>
											<u-col span="12">
												<view class="goods-row">
													<text class="label">金额：</text>
													<u-text mode="price" :text="inout.eachAmount"></u-text>
												</view>
											</u-col>
											<u-col span="12">
												<view class="goods-row">
													<text class="label">备注：</text>
													<text class="value">{{inout.remark || '-' }}</text>
												</view>
											</u-col>
										</u-row>
									</view>
			...
			<u-row gutter="10">
				...
				<u-col span="12">
					<view class="goods-row">
						...
						<u-text :text="AdvanceInList.accountName"></u-text>
					</view>
				</u-col>
				<u-col span="12">
					<view class="goods-row">
