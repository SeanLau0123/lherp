...
<template>
	<view style="min-height: 100vh;">
			...
			<u-row gutter="10">
				<u-col span="12">
					<view class="goods-row">
						...
						<u-text :text="TransferList.handsPersonName"></u-text>
					</view>
				</u-col>
				<u-col span="12">
					<view class="goods-row">
						<text class="label">单据日期：</text>
						<u-text>{{ $u.timeFormat(TransferList.billTimeStr, 'yyyy-mm-dd hh:MM:ss') }}</u-text>
					</view>
				</u-col>
				<u-col span="12">
					<view class="goods-row">
						<text class="label">单据编号：</text>
						<u-text :text="TransferList.billNo"></u-text>
					</view>
				</u-col>
			</u-row>
		</view>
		...
		<view class="good-item">
			<u-row gutter="10">
				<template v-if="TransferList.remark">
					<u-col span="12">
						<view class="goods-row">
							<text class="label">备注：</text>
							<u-text :text="TransferList.remark"></u-text>
						</view>
					</u-col>
				</template>
				<u-col span="12">
					<view class="goods-row">
						...
						<u-text :text="TransferList.accountName"></u-text>
					</view>
				</u-col>
				<u-col span="12">
					<view class="goods-row">
						<text class="label">实付金额：</text>
						<u-text mode="price" :text="TransferList.changeAmount"></u-text>
					</view>
				</u-col>
