<template>
	<view style="height: 100vh;">
			...
			<u-row gutter="10">
				...
				<u-col span="12">
					<view class="goods-row">
						...
						<u-text mode="date" :text="InDetailList.operTime"></u-text>
					</view>
				</u-col>
				<u-col span="12">
					<view class="goods-row">
										...
										<u-row gutter="10">
											...
											<u-col span="12">
												<view class="goods-row" v-if="good.enableSerialNumber === '1'">
													...
													<u-textarea v-model="good.snList" autoHeight disabled />
												</view>
											</u-col>
											<u-col span="12">
												<view class="goods-row">
		...
		<u-col span="12">
			<!-- accountHead/getFinancialBillNoByBillId?billId=38 -->
			<view class="good-item" style="min-height: 80rpx;" v-if="billNo">
				<view class="goods-row">
