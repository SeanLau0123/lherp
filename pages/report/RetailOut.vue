...
<template>
	<view style="height: 100vh;">
		...
		<u-sticky>
			<view class="sticky">
				<u-text :bold="true" text="实际零售金额："></u-text>
		...
		<scroll-view class="scrollviewpadding">
			...
			<view v-for="(retailOut, index) in retailOutList" :key="retailOut.barCode || index">
				<view class="good-item">
					<u-row gutter="10">
						...
						<u-col span="5">
							<view class="goods-row">
								<text class="label">零售数量：</text>
								<u-text :text="retailOut.outSum"></u-text>
							</view>
						</u-col>
						<u-col span="7">
							<view class="goods-row">
								<text class="label">零售金额：</text>
								<u-text mode="price" :text="retailOut.outSumPrice"></u-text>
							</view>
						</u-col>
						<u-col span="5">
							<view class="goods-row">
								<text class="label">退货数量：</text>
								<u-text :text="retailOut.inSum"></u-text>
							</view>
						</u-col>
						<u-col span="7">
							<view class="goods-row">
								<text class="label">退货金额：</text>
								<u-text mode="price" :text="retailOut.inSumPrice"></u-text>
							</view>
						</u-col>
						<u-col span="12">
							<view class="goods-row">
								<text class="label">实际零售金额：</text>
								<u-text mode="price" :text="retailOut.outInSumPrice"></u-text>
...
<script setup lang="ts">
	...
	const loadgetretailOutList = async () => {
		let params = {
