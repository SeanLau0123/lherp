...
<template>
	<view style="height: 100vh;">
		...
		<u-sticky>
			<view class="sticky">
				<u-text :bold="true" text="实际销售金额："></u-text>
		...
		<scroll-view class="scrollviewpadding">
			...
			<view v-for="(saleOut, index) in saleOutList" :key="saleOut.barCode || index">
				<view class="good-item">
					<u-row gutter="10">
						<u-col span="12">
							<u-collapse :head-style="headStyle">
								<u-collapse-item :title="saleOut.materialName">
									<view class="goods-row">
										<text class="label">品牌：</text>
										<u-text :text="saleOut.materialBrand"></u-text>
										<text class="label">制造商：</text>
										<u-text :text="saleOut.materialMfrs"></u-text>
									</view>
						...
						<u-col span="5">
							<view class="goods-row">
								...
								<u-text :text="saleOut.outSum"></u-text>
							</view>
						</u-col>
						<u-col span="7">
							<view class="goods-row">
								<text class="label">销售金额：</text>
								<u-text mode="price" :text="saleOut.outSumPrice"></u-text>
							</view>
						</u-col>
						<u-col span="5">
							<view class="goods-row">
								<text class="label">退货数量：</text>
								<u-text :text="saleOut.inSum"></u-text>
							</view>
						</u-col>
						<u-col span="7">
							<view class="goods-row">
								<text class="label">退货金额：</text>
								<u-text mode="price" :text="saleOut.inSumPrice"></u-text>
							</view>
						</u-col>
						<u-col span="12">
							<view class="goods-row">
								<text class="label">实际销售金额：</text>
								<u-text mode="price" :text="saleOut.outInSumPrice"></u-text>
...
<script setup lang="ts">
	...
	const loadgetsaleOutList = async () => {
		let params = {
