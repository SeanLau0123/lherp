...
<template>
	<view style="height: 100vh;">
		...
		<u-sticky>
			<view class="sticky">
				<u-text :bold="true" text="期初应付："></u-text>
				<u-text :bold="true" mode="price" :text="firstMoney"></u-text>
				<u-text :bold="true" text="，期末应付："></u-text>
		...
		<scroll-view class="scrollviewpadding">
			...
			<view v-for="(item, index) in supplierAccountList" :key="item.id || index">
